...
function MaskHighlightRules () {
    ...
    this.$rules = {
        "start" : [
            ...
            Blocks.syntax(/(slot|event)\b/, "scripts-block", "block"),
            Blocks.syntax(/style\b/, "css-block", "block"),
            Blocks.syntax(/var\b/, "scripts-statement", "attr"),
...
var Blocks = {
    ...
    expression: function(){
        return Token(token_LPARE, /\(/, [ "scripts-statement-start" ]);
    },
    word: function(){
